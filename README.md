-- LocalScript para StarterPlayerScripts (Mobile, Bola RGB central real)
...
local function isVisible(part)
    ...
    local result = workspace:Raycast(origin, dir, rayParam)
...
------------------ RGB Animation & Aimbot (toggle) ------------------
local aiming = false

aimButton.MouseButton1Click:Connect(function()
    aiming = not aiming
    aimButton.Text = aiming and "AIM ON" or "AIM OFF"
    aimButton.BackgroundColor3 = aiming and Color3.fromRGB(220,30,30) or Color3.fromRGB(40,40,40)
end)

RunService.RenderStepped:Connect(function()
    -- Animação do arco-íris usando HSV
    local hue = (tick()%6)/6
    aimCircle.BackgroundColor3 = Color3.fromHSV(hue,1,1)
